  ...
  var m = window.MutationObserver || window.WebKitMutationObserver || !1,
    ...
    w = function () {
      function e() {
        ...
        return "url(../images/openhand.cur),n-resize";
      }
      if (g) return g;
              ...
              (v.scrollmom = new b(v)),
                (v.onmangotouch = function (e) {
                  var o = v.getScrollTop(),
                    t = v.getScrollLeft();
                  if (
                    o == v.scrollmom.lastscrolly &&
                    t == v.scrollmom.lastscrollx
                  )
                    return !0;
                  ...
                  if (0 != n) {
                    ...
                    if (
                      ...
                      v.mangotouch.tm = a;
                      var c = Math.max(
                        Math.abs(v.mangotouch.ly - o),
                        Math.abs(v.mangotouch.lx - t)
                      );
                      (v.mangotouch.ly = o),
                        (v.mangotouch.lx = t),
                        c > 2 &&
